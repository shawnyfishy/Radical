...
// The CSS starts after the markdown frontmatter '---'
...
fs.writeFileSync('scratch/formatted_webflow.css', formatted, 'utf8');
console.log('Saved formatted CSS to scratch/formatted_webflow.css, total blocks:', blocks.length);
